...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Nov 2022 pada 17.42
...
INSERT INTO `pengajuan_instansi` (`id_pengajuan`, `nama_mahasiswa`, `nim_mahasiswa`, `email_mahasiswa`, `telp_mahasiswa`, `foto_mahasiswa`, `sks_lulus`, `nama_instansi`, `url_medsos_instansi`, `alamat_instansi`, `penerima_surat`, `jabatan_penerima_surat`, `objek_pkl`, `waktu_pelaksanaan`, `khs`) VALUES
(1, 'Tanzilu Adji Arriduwan', 225150209111007, 'tanziluadji@gmail.com', 82230963464, 'fototanzilu.jpg', 4, 'PT Pelni Persero', NULL, 'Jalan Gajah Mada No.14, RT.6/RW.2', 'Rainoc', 'Direktur Sumber Daya Manusia (SDM) & Umum', 'IT Support', '3 Oktober 2022 - 3 Desember 2022', 'rekapstuditanzilu.pdf'),
(2, 'Hadi Ikhwanul Fuadi', 225150209111002, 'hadiikhwanul@student.ub.ac.id', 81997963759, 'fotohadi.jpg', 4, 'PT Pertamina (Persero)', NULL, 'Jalan Medan Merdeka Timur. No.1A', 'M Herry Sugiharto', 'Direktur Sumber Daya Manusia (SDM)', 'Software Enginering', '3 Oktober 2022 - 3 Desember 2022', 'khshadi.pdf'),
(3, 'Kharisma Aryawitama', 225150209111004, 'kharismaarya@student.ub.ac.id', 87722882322, NULL, 4, 'PT Garuda Indonesia, Tbk.', NULL, 'Jalan Jendral Sudirman Kav 29-31, Jakarta', 'Salman El Farisiy', 'Direktur Human Capital', 'Website Developer', '3 Oktober 2022 - 3 Desember 2022', 'khsharisma.pdf'),
(4, 'Fadila Kharisma Yoga', 225150209111008, 'fadilayoga@student.ub.ac.id', 8113135523, NULL, 4, 'PT Kereta Api Indonesia (Persero)', NULL, 'Jalan Pegangsaan Timur No.6', 'Suparno', 'Direktur Sumber Daya Manusia (SDM) & Umum', 'Mobile Developer', '03 Oktober 2022 s/d 03 Desember 2022', 'khsfadila.pdf'),
(5, 'Ahmad Madda Iknajah', 225150209111013, 'ahmadmadda@student.ub.ac.id', 82220508262, 'fotomamad.jpeg', 4, 'PT Perusahaan Listrik Negara (PLN) Persero', NULL, 'Jalan Trunojoyo Blok M – I No 135 Kebayoran Baru, Jakarta', 'Yusuf Didi Setiarto', 'Direktur Legal dan Manajemen Human Capital', 'Full Stack Developer', '3 Oktober 2022 - 3 Desember 2022', 'khsmadda.pdf'),
(6, 'Denny Prastyo Inkiriwang', 225150209111014, 'dennyprastyo@student.ub.ac.id', 81229406595, NULL, 4, 'PT Telkom Indonesia Tbk', NULL, 'Jalan Kebon Sirih No 10-12, Jakarta Pusat', 'Afriwandi', 'Direktur Human Capital Management', 'Data Science', '03 Oktober 2022 s/d 03 Desember 2022', 'khsdenny.pdf');
...
INSERT INTO `pengajuan_lomba` (`id_pengajuan`, `nama_mahasiswa`, `nim_mahasiswa`, `email_mahasiswa`, `telp_mahasiswa`, `foto_mahasiswa`, `sks_lulus`, `kategori_lomba`, `tingkat_lomba`, `nama_lomba`, `penyelenggara`, `produk_lomba`, `hasil_lomba`, `pembimbing`, `url_informasi_lomba`, `tempat_pelaksanaan`, `waktu_lomba`, `sumber_dana`, `proposal_lomba`, `sertifikat_lomba`) VALUES
(1, 'Muhammad Davva Pratama', 193140714111070, 'davvapratama@student.ub.ac.id', 81383868858, 'fotogalih', 4, 'Karya Tulis Ilmiah TIK', 'Nasional', 'Gemastik XV', 'Pusat Prestasi Nasional', 'Karya Tulis Ilmiah - TIK', 'Juara 1', 'Denny Sagita Rusdianto', NULL, 'Fakultas Ilmu Komputer - Universitas Brawijaya Malang', '22 November 2022 - 25 November 2022', 'Kemahasiswaan Fakultas', 'proposallomba.pdf', 'sertifikatlomba.pdf'),
(2, 'Galih Bagus Prasojo', 193140714111014, 'galihbagusprasojo@student.ub.ac.id', 82386901253, 'fotodavva', 4, 'Pengembangan Perangkat Lunak', 'Nasional', 'Gemastik XV', 'Pusat Prestasi Nasional', 'Pengembangan Perangkat Lunak', 'Juara 3', 'Denny Sagita Rusdianto', NULL, 'Fakultas Ilmu Komputer - Universitas Brawijaya', '22 November - 25 November 2022', 'Kemahasiswaan Fakultas', 'proposalgalih.pdf', 'sertifikatgalih.pdf');
...
(5, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Pengajuan Berkas'),
...
(2, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Pengajuan Berkas');
